...
function openRsvpDialog(){formStatus.className="form-status";formStatus.textContent="";rsvpDialog.showModal();document.body.classList.add("dialog-open");setTimeout(()=>attendance.focus(),0)}
